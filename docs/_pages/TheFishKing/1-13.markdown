...
Moving into a big action sequence now has allowed me to experiment with doing more strips where it’s just a few detailed panels instead of several small and intricate ones. It comes with its own challenges but it’s been fun so far!